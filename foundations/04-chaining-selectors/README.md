...
### Self Check
- Did you properly chain class selectors for each rule? y
- Does the `proportioned` image retain its original square proportions? y 
- Does the `distorted` image end up looking squished and, well, distorted? y
